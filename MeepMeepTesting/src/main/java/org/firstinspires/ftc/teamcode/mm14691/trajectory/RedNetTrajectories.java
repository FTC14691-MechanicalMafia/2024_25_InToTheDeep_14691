...
public class RedNetTrajectories {
    ...
    public static void main(String[] args) {
        ...
        TrajectoryActionBuilder startToBasket = startToBasket(myBot.getDrive().actionBuilder(
                new Pose2d(-34, -65, Math.toRadians(90))));
        //, turn counter clock heading to positive Y is positive 90 degree, heading toward X positive is 0 degree
...
//        myBot.runAction(nSample3ToBasket.build());
    ...
    public static TrajectoryActionBuilder startToBasket(TrajectoryActionBuilder builder) {
        return builder
                ...
                .splineTo(new Vector2d(-50.0, -50.0), Math.PI*1.25);
        //2Pi is 360 degree
        // Pi is 180 degree this is 225 degree counter clock wise
    }
    ...
    public static TrajectoryActionBuilder basketToNSample1(TrajectoryActionBuilder builder) {
        return builder
                ...
                .splineTo(new Vector2d(-37.25, -44.0), 0.35*-Math.PI);
