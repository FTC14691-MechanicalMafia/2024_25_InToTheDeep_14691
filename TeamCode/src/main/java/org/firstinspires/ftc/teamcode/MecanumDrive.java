...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.9958396034345; // 108/108.4512 in manually pushed
        public double lateralInPerTick = 0.6965953926672951;
        public double trackWidthTicks = 15.702457320752027;// Needs to be greater than 0 or strafing does not work;

        // feedforward parameters (in tick units)
        public double kS = 1.7473116533531647;
        public double kV = 0.18166739271981072;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // set up the two wheel localizer.  If the pinpoint was successful this isn't used anyway.
